...
HTMLCodeElement.appendStyle(":host {font-size: 1em;}.edit {font-family: monospace;}.lines, .copy {font-family: sans-serif;}.copy {position: absolute;top: 0;right: 0;cursor: pointer;margin: 0.25em;padding: 0.5em;background-color: inherit;user-select: none;}.highlighted {background-color: #FFFFDA;}");
})();